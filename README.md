...
Clone or download a zip of this repo to a folder, then open up a command prompt (cmd) window in that location. Tgxpack.exe should be placed next to TGX_FILES, in the same folder.
Run tgxpack by simply typing tgxpack.exe (Or whatever version you're using) then follow the help commands.

Your next command should be:
tgxpack pack TGX_FILES
